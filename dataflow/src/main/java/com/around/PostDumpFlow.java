...
public class PostDumpFlow {
  ...
  private static final String PROJECT_ID = "temporal-sweep-185822";
 ...
 // mvn compile exec:java -Dexec.mainClass=com.around.PostDumpFlow -Dexec.args="--project=temporal-sweep-185822 --stagingLocation=gs://dataflow-around_185822/staging/ --tempLocation=gs://dataflow-around_185822/output --runner=DataflowPipelineRunner --jobName=dataflow-intro"